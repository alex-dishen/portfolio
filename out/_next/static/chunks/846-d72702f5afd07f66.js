  ...
  [846],
  {
    ...
    7095: function (e, t, r) {
      ...
      let P = o.default.forwardRef(function (e, t) {
          ...
          o.default.useEffect(() => {
            T && $ && U && m(T, A, W, { locale: E }, { kind: N }, L)
          }, [W, A, $, E, U, null == I ? void 0 : I.locale, T, L, N])
          let H = {
            ref: B,
            onClick(e) {
          ...
          if ((0, l.isAbsoluteUrl)(W)) H.href = W
            ...
            H.href =
              t ||
              (0, h.addBasePath)(
                (0, c.addLocale)(W, e, null == I ? void 0 : I.defaultLocale),
              )
          }
          return k
            ? o.default.cloneElement(n, H)
            : o.default.createElement('a', { ...w, ...H }, r)
        }),
        v = P
      ;('function' == typeof t.default ||
        ('object' == typeof t.default && null !== t.default)) &&
        ...
        try {
          ...
          if ((0, c.isDynamicRoute)(e.pathname) && e.searchParams && r) {
            let r = (0, n.searchParamsToUrlQuery)(e.searchParams),
              { result: i, params: a } = (0, f.interpolateAs)(
                e.pathname,
                e.pathname,
                r,
              )
          ...
          let i = e.origin === s.origin ? e.href.slice(e.origin.length) : e.href
          return r ? [i, t || i] : i
        } catch (e) {
          return r ? [d] : d
        }
    ...
    965: function (e, t, r) {
      ...
      function c(e) {
        let t,
          r,
          { segment: n, routeKeys: o, keyPrefix: u } = e,
          a =
            ((t = 97),
            (r = 1),
            () => {
          ...
          { key: l, optional: c, repeat: f } = i(n),
          s = l.replace(/\W/g, '')
        u && (s = '' + u + s)
        let d = !1
        return (
          (0 === s.length || s.length > 30) && (d = !0),
      ...
      function f(e, t) {
        let r = (0, u.removeTrailingSlash)(e).slice(1).split('/'),
          i = {}
        return {
